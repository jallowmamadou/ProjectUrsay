              <div class="" style="padding: 8px 16px">
              ...
              {{-- Post Card --}}
                <div class="mdl-layout__tab-panel is-active" id="feed" style="margin:16px;">
                  <section class="section--center mdl-grid mdl-grid--no-spacing mdl-shadow--2dp">
                      ...
                      <div class="mdl-card__actions" style="border: 0;">
                        ...
                        <button class="mdl-button mdl-js-button mdl-button--icon">
                          <i class="material-icons">thumb_down</i>
                            ...
                            {{-- Post Card --}}
                <div class="mdl-layout__tab-panel" id="latest">
                  <section class="section--center mdl-grid mdl-grid--no-spacing mdl-shadow--2dp">
                    <div class="mdl-card mdl-cell mdl-cell--12-col">
                      <div class="mdl-card__supporting-text flexed">
                        <a href="#" class="post-avatar">
                      ...
                      <div class="mdl-card__actions">
                        ...
                        <button class="mdl-button mdl-js-button mdl-button--icon">
                          <i class="material-icons">thumb_down</i>
                            ...
                            {{-- Post Card --}}
                <div class="mdl-layout__tab-panel" id="top">
                  <section class="section--center mdl-grid mdl-grid--no-spacing mdl-shadow--2dp">
                    <div class="mdl-card mdl-cell mdl-cell--12-col">
                      <div class="mdl-card__supporting-text flexed">
                        <a href="#" class="post-avatar">
